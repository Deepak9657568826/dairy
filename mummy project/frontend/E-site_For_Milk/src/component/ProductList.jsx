            ...
            <div key={product._id} className="product-card">
              ...
              {role == "admin" && (
                <p className="product-quantity">
                  ...
                  {product.productname == "दही" ? `gram` : `ml`}
                </p>
              )}
        ...
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogBody color="tomato">
              {name}, Your order has been placed successfully! We will contact
              you shortly at {phoneNumber}.
            </AlertDialogBody>
            <AlertDialogFooter>
      ...
      >
        <AlertDialogOverlay>
          <AlertDialogContent>
            ...
            <AlertDialogBody>Are you sure delete product?</AlertDialogBody>
